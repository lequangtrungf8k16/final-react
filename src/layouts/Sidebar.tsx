...
const ProfileAvatar = ({ className }: { className?: string }) => {
  ...
  if (user?.profilePicture) {
    return (
      <img
        ...
        alt={user.username}
        className={cn(
          "h-6 w-6 rounded-full object-cover border border-gray-200",
          className,
        )}
      />
    );
  ...
  return (
    <div
      className={cn(
        "h-6 w-6 rounded-full bg-gray-200 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 flex items-center justify-center text-[10px] font-bold text-gray-600 dark:text-gray-300",
        className,
      )}
    >
      {firstLetter}
...
const SIDEBAR_ITEMS: SidebarItemType[] = [
  ...
  { type: "link", href: "/profile", label: "Profile", icon: ProfileAvatar },
];
      ...
      >
        <div
          className={cn(
            ...
            activePanel ? "justify-center" : "justify-center lg:justify-start",
          )}
        >
        ...
        <div className="hidden md:flex flex-col gap-2 px-3 mt-auto">
          ...
          >
            ...
            <DropdownMenuItem className="cursor-pointer">
              <SquareActivity className="mr-2 h-4 w-4" /> Your activity
            </DropdownMenuItem>
            <DropdownMenuItem className="cursor-pointer">
            ...
            <DropdownMenuItem className="cursor-pointer">
              <MessageSquareWarning className="mr-2 h-4 w-4" /> Report a problem
            </DropdownMenuItem>
